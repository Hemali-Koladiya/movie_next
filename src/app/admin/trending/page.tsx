            ...
            <ProtectedRoute>
                <div className="p-6">
                    <div className="flex justify-between items-center mb-6">
                        <h1 className="text-2xl font-bold text-black">Manage Trending Items</h1>
                        <button
                            ...
                            <div key={item.id} className="flex items-center justify-between p-4 bg-white rounded-lg shadow">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="px-3 py-1 bg-gray-100 rounded hover:bg-gray-200 text-black"
                                    >
                                    ...
                                    <button className='ms-4 hover:opacity-70' onClick={() => handleDelete(item.id)}>
                                        <Trash2 color='red' />
                                    </button>
                                </div>
                            </div>
